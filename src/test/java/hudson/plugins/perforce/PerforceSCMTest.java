...
public class PerforceSCMTest extends HudsonTestCase {
    ...
    public void testConfigRoundtrip() throws Exception {
        ...
        PerforceSCM scm = new PerforceSCM(
        		...
        		"sysDrive", "label", "counter", false, true, true, true, false, 0, browser);
        project.setScm(scm);
        ...
        assertEqualBeans(scm, project.getScm(),
                "p4User,p4Client,p4Port,p4Label,projectPath,p4Exe,p4SysRoot,p4SysDrive,forceSync,dontRenameClient,updateView,firstChange,p4Counter,updateCounterValue,exposeP4Passwd");
